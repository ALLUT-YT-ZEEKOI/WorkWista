        ...
        child: Column(
          ...
          children: [
            ...
            const Text('Welcome to Workwista 👋',
                textAlign: TextAlign.center, style: AppTextStyle.heading),
                ...
                GestureDetector(
                    onTap: () {
                      Navigator.push(
                        ...
                        PageTransition(
                          type:
                              PageTransitionType.rightToLeft, // Fade transition
                          child: const Forgotpassword(),
                          childCurrent:
                              const SplashScreen(), // Optional: For better transition effects
